...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, OUT_PWRKEY_GSM_Pin|OUT_RST_GSM_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : IN_STATUS_GSM_Pin */
  GPIO_InitStruct.Pin = IN_STATUS_GSM_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(IN_STATUS_GSM_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : OUT_PWRKEY_GSM_Pin OUT_RST_GSM_Pin */
  GPIO_InitStruct.Pin = OUT_PWRKEY_GSM_Pin|OUT_RST_GSM_Pin;
